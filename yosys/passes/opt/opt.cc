...
struct OptPass : public Pass
{
	...
	void execute(std::vector<std::string> args, RTLIL::Design *design) override
	{
		...
		if (fast_mode)
		{
			while (1)
			{
				Pass::call(design, "my_opt_expr" + opt_expr_args);
				Pass::call(design, "my_opt_strength");
				Pass::call(design, "my_opt_cse");
		...
		else
		{
			...
			{
				design->scratchpad_unset("opt.did_something");
				Pass::call(design, "my_opt_muxtree");
				Pass::call(design, "my_opt_reduce" + opt_reduce_args);
				Pass::call(design, "my_opt_rewrite");
				Pass::call(design, "my_opt_cover");
				Pass::call(design, "my_opt_qm");
				Pass::call(design, "my_opt_kernel");
				Pass::call(design, "my_opt_dce");
				Pass::call(design, "opt_merge" + opt_merge_args);
				if (opt_share)
					Pass::call(design, "my_opt_share");
				if (!noff_mode)
					Pass::call(design, "opt_dff" + opt_dff_args);
				Pass::call(design, "opt_clean" + opt_clean_args);
